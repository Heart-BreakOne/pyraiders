...
class PyRaidersGUI:
    def __init__(self, master):
        ...
        try:
            ...
            try:
                ...
                root.call(
                    ...
                    "iconphoto",
                    root._w,
                    PhotoImage(file="assets/icons/icon-128.png"),
                )
            except TclError as e:
        ...
        self.photo1 = PhotoImage(file=image_path1)
        self.photo1 = self.photo1.subsample(2, 2)
        self.label1 = Label(master, text="VIEWER", image=self.photo1, compound="top")
        self.label1.place(x=0, y=0)
        self.label1.bind("<Button-1>", self.on_viewer_click)

        # Load the second image
        image_path2 = "assets/images/captain.png"
        self.photo2 = PhotoImage(file=image_path2)
        self.photo2 = self.photo2.subsample(2, 2)
        print(self.photo2)
        self.label2 = Label(master, text="CAPTAIN", image=self.photo2, compound="top")
